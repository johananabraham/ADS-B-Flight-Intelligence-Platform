  ...
  return (
    <div className="min-h-dvh bg-surface-0 text-slate-200">
      ...
      <main id="recorded-evidence" className="mx-auto max-w-6xl px-4 py-10 md:px-8" tabIndex={-1}>
        ...
        <nav className="mt-8 grid gap-3 text-sm sm:grid-cols-2 lg:grid-cols-3" aria-label="Project evidence links">
          ...
          <a className="panel flex min-h-11 items-center p-4 text-cyan-300 transition-colors hover:border-cyan-500 motion-reduce:transition-none" href={`${repository}/blob/main/docs/BENCHMARK_METHODOLOGY.md`}>Benchmark methodology</a>
          <a className="panel flex min-h-11 items-center p-4 text-cyan-300 transition-colors hover:border-cyan-500 motion-reduce:transition-none" href={`${repository}/blob/main/docs/DATA_MODEL_CARD.md`}>Data &amp; model card</a>
          <a className="panel flex min-h-11 items-center p-4 text-cyan-300 transition-colors hover:border-cyan-500 motion-reduce:transition-none" href={`${repository}/blob/main/evaluation/manifests/public-anomaly-sources-v1.json`}>Dataset manifest</a>
