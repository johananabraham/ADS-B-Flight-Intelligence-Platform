...
Dependency license texts and notices remain with their distributions. This file
records assets/data with separate publication obligations; it is not legal advice.

| Material | Use | Rights/decision |
|---|---|---|
| OpenStreetMap tiles | Live Leaflet basemap only | Runtime attribution displayed; tiles are not bundled |
...
No public RF capture, public anomaly archive, surrounding trace, screenshot, or
demo video is currently committed. Before adding one, record source, version,
checksum, access date, license identifier, attribution text, transformation, and
redistribution decision in a manifest and update this notice.
