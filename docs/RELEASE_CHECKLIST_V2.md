...
| Python lint/type/tests and migrations | PASS | Ruff clean; mypy clean across 22 v2 sources; 322 backend tests pass and 1 is skipped; one Alembic head and offline upgrade pass |
